...
class ClassificationsControllerTest < ActionController::TestCase
  ...
  test "should create classification" do
    assert_difference('Classification.count') do
      post :create, classification: { classification_id: @classification.classification_id, description: @classification.description, hierarchy_id: @classification.hierarchy_id, name: @classification.name }
    end
  ...
  test "should update classification" do
    patch :update, id: @classification, classification: { classification_id: @classification.classification_id, description: @classification.description, hierarchy_id: @classification.hierarchy_id, name: @classification.name }
    assert_redirected_to classification_path(assigns(:classification))
  end
